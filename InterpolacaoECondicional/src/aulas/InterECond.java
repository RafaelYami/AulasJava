...
public class InterECond {

	public static void main(String[] args) {
        Scanner leia = new Scanner(System.in).useLocale(Locale.US);
		
		//%s=string; %d=int; %f=double; %c=char.
        /*
		...
		*/
		...
		switch (numero) {
		case 1:
			System.out.println("Voçê digitou 1!");
			break;

		case 2:
			System.out.println("Voçê digitou 2!");
			break;

		default:
			System.out.println("Voçê digitou um número maior que 2 ou não digitou um número!");
			break;
		}
